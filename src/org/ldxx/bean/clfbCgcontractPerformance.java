...
public class clfbCgcontractPerformance {
	...
	private String provisionalMoney;//暂定金
	private String settlementMoney;//结算金额
	private String settlementDesc;//结算说明
	private String accumulativePaymentMoney;//累计付款
	...
	public void setAccumulativePaymentMoney(String accumulativePaymentMoney) {
