...
public class TechnicalDocumentation {
    ...
    private List<Accessory> accessory4;//工作大纲及评审记录
    private List<Accessory> accessory5;//中间报告及评审记录
    private List<Accessory> accessory6;//成果简介
    private List<Accessory> accessory7;//研究报告
    private List<Accessory> accessory8;//查新报告
    private List<Accessory> accessory9;//总结报告
    private List<Accessory> accessory10;//用户报告/应用证明
    private List<Accessory> accessory11;//鉴定(评审)证书/验收评审意见
    private List<Accessory> accessory12;//科研项目其他成果
    private List<Accessory> accessory13;//汇报PPT
    private List<Accessory> accessory14;//财务决算表
